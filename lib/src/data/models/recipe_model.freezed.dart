...
class _$_RecipeModel extends _RecipeModel {
  ...
  @override
  String toString() {
    return 'RecipeModel(vegetarian: $vegetarian, vegan: $vegan, glutenFree: $glutenFree, dairyFree: $dairyFree, veryHealthy: $veryHealthy, cheap: $cheap, veryPopular: $veryPopular, sustainable: $sustainable, lowFodmap: $lowFodmap, weightWatcherSmartPoints: $weightWatcherSmartPoints, gaps: $gaps, preparationMinutes: $preparationMinutes, cookingMinutes: $cookingMinutes, aggregateLikes: $aggregateLikes, healthScore: $healthScore, creditsText: $creditsText, license: $license, sourceName: $sourceName, pricePerServing: $pricePerServing, extendedIngredients: $extendedIngredients, id: $id, title: $title, readyInMinutes: $readyInMinutes, servings: $servings, sourceUrl: $sourceUrl, image: $image, imageType: $imageType, summary: $summary, instructions: $instructions, analyzedInstructions: $analyzedInstructions, spoonacularSourceUrl: $spoonacularSourceUrl, cuisines: $cuisines, dishTypes: $dishTypes, diets: $diets, occasions: $occasions, originalId: $originalId)';
  }
...
abstract class _RecipeModel extends RecipeModel {
  const factory _RecipeModel(
      ...
      required final List<String?> diets,
      required final List<String?> occasions,
      final int? originalId}) = _$_RecipeModel;
